...
<div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title" align="center">REPORTE DE MATERIAS PRIMAS</h3>
                ...
                <div class="box-body">
                  ...
                  <?php foreach($data as $material){ ?>
                    <tr>
                      ...
                      <td align="center">{{$material->precio}}</td>
                      <td align="center">{{$material->stock}}</td>
                      <td align="center"><?= $material->descripcion; ?></td>
                    </tr>
